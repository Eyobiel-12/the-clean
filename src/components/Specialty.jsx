...
const WHATSAPP_URL = `https://wa.me/31854015937?text=${encodeURIComponent('Hallo! Ik wil graag een afspraak plannen voor gordijnreiniging.')}`
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-16 gap-8 lg:gap-20 items-center">
          ...
          <div ref={textRef} className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg text-stone-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Gordijnen zijn ons sterkste punt. Zwaar vervuild, verkleurd of met vlekken – wij maken ze weer als nieuw met professionele apparatuur en jarenlange ervaring.
            </p>
            <motion.a
              href={WHATSAPP_URL}
              target="_blank"
